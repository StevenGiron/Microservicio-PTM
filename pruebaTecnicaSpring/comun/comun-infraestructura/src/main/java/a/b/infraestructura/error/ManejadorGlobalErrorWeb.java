package a.b.infraestructura.error;

import a.b.dominio.excepcion.*;
...
public class ManejadorGlobalErrorWeb extends AbstractErrorWebExceptionHandler {
    ...
    private static final String PACKAGE = "a.b";
    ...
    private Mono<ServerResponse> renderErrorResponse(ServerRequest request) {
        ...
        if (throwable instanceof ResponseStatusException) {
            codigoRespuesta = ((ResponseStatusException) throwable).getStatusCode().value();
        }
